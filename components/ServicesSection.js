...
const services = [
    ...
    { name: "PSYCHOLOGICAL COUNSELLING AND PSYCHO-EDUCATIONAL ASSESSMENT", slug: "psychological-counselling", desc: "Clinical assessment and supportive counseling care.", icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 3a8 8 0 0 1 8 8c0 3-1.6 5-3.5 6.2V21l-3.1-2.2A8.3 8.3 0 0 1 12 19a8 8 0 0 1 0-16z"/><circle cx="9" cy="11" r="1"/><circle cx="15" cy="11" r="1"/></svg>' },
