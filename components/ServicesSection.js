...
const services = [
    ...
    { name: "BEHAVIOUR THERAPY", slug: "behaviour-therapy", desc: "Improving communication, addressing challenging behaviours and building independence.", icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 21s-7-4.4-7-10a4 4 0 0 1 7-2.7A4 4 0 0 1 19 11c0 5.6-7 10-7 10z"/></svg>' },
